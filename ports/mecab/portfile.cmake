...
# NOTE (QVAC-21839): the upstream mecab port passes WINDOWS_USE_MSBUILD, which
# forces the "Visual Studio NN YYYY" generator. Our self-hosted Windows runners
# were upgraded to Visual Studio 2026 ("Visual Studio 18 2026"), a generator the
# vcpkg-bundled CMake (3.31.10) does not know, so mecab fails to configure and
# blocks the whole tts-ggml Windows prebuild. Dropping WINDOWS_USE_MSBUILD lets
# the default Ninja generator drive cl.exe, which is generator/VS-version
# agnostic. Everything else mirrors the upstream port exactly. Same fix pattern
# as tts-onnx (QVAC-19263).
