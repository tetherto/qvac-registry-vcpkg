...
# guard row-wise Vulkan shaders against padded-dispatch OOB writes). Bumps the
# speech-stack ggml pin from 11581cd5 to bring the LavaSR denoiser/enhancer
# fused ops the tts-cpp master pin now requires: the fused OpenCL ops
# (GRU / CONV_2D_DW / ZERO_UPSAMPLE / CHANNEL_SHUFFLE / AFFINE_PRELU, PR #39)
# and the matching Vulkan kernels + fusions (PR #41), plus the Vulkan
# rowwise-shader OOB guard (PR #40). These ggml_gru/ggml_zero_upsample/
# ggml_affine_prelu/ggml_channel_shuffle symbols are referenced unconditionally
# by tts-cpp's lavasr/denoiser_ggml.cpp, so consuming tts-cpp@master (PR #86/#89:
# LavaSR denoiser/enhancer on a ggml compute graph) needs this pin.
